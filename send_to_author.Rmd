...
recreating author example. Numbers are a little different than mine, but they're close.

  * F-stat off due to rounding?
  * Isn't p-value supposed to be halved? since they double their significance level (e.g. if $\alpha = 0.05$, they would look for $2\alpha$, that's why it's under the subscript.)
...
```
But shouldn't this p-value effectively be divide by 2 since the significance level is doubled?
